...
if (language === 'ru') {
    ...
    tipTexts['bios-stack__js'] = 'Use vanilla JS (+TS) as for React applications as well for rework several sites.';
    ...
    tipTexts['bios-stack__react'] = 'Created application from scratch, analyze application architecture by myself, analyzed and seriously rewrite (rework) exist projects, actively used TS.';
    ...
    tipTexts['softwise-stack__jquery'] = 'Rewrite legacy code to modern language stack or reworked its functionality';
    tipTexts['softwise-stack__js'] = 'ES5 and ES6+, TS, took part in the JS linter and task-runner (gulp) reworking, wrote rules for YouTrack workflows, solved the most different tasks (as the site reworking as well reworking invisible advertising scripts) and a lot of other things.';
