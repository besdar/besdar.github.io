...
<div className={blogStyles["blog-table-scroll"]}>
    <table className={blogStyles["blog-table"]} aria-label="Previous and target HP CM1015 printer connection configuration">
        <thead>
            <tr>
                <th scope="col">Component</th>
                <th scope="col">Model / Version</th>
                <th scope="col">Previous Configuration</th>
