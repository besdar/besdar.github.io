...
export const ContactLinks: React.FC = () => (
    <nav
        ...
        className={cn(
            styles["title-contacts-contact"],
            styles["contacts-links"],
            styles["contacts-links-margin-top"],
            baseStyles["not-printed"],
        )}
    >
        <a aria-label="Email Dmitry Beskov" className={styles["contacts-link-link"]} rel="noopener" href="mailto:dmitry.beskov@outlook.com">
            <svg aria-hidden="true" focusable="false" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                <path
        ...
        <a
            aria-label="Dmitry Beskov on LinkedIn"
            className={styles["contacts-link-link"]}
            rel="noopener noreferrer"
            href="https://www.linkedin.com/in/besdar/"
            target="_blank"
        >
            <svg aria-hidden="true" focusable="false" version="1.1" viewBox="0 0 144 144" xmlns="http://www.w3.org/2000/svg">
                <path
                    fill="#0077B7"
        ...
        <a
            aria-label="Dmitry Beskov on LeetCode"
            className={styles["contacts-link-link"]}
            rel="noopener noreferrer"
            href="https://leetcode.com/besdar/"
            target="_blank"
        >
            <svg aria-hidden="true" focusable="false" version="1.1" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path
                    fill="gray"
                    xmlns="http://www.w3.org/2000/svg"
        ...
        <a
            aria-label="Dmitry Beskov on Telegram"
            className={styles["contacts-link-link"]}
            rel="noopener noreferrer"
            href="https://t.me/besdarrr"
            target="_blank"
        >
            <svg aria-hidden="true" focusable="false" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32">
                <path
        ...
        <a
            aria-label="Dmitry Beskov on GitHub"
            className={styles["contacts-link-link"]}
            rel="noopener noreferrer"
