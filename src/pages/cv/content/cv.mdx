...
<ImpactEvidence
    ...
    items={[
        ...
        },
        {
            value: "~55%",
            label: "Authored MRs",
            description: "Authored the majority of core-project code changes among a team of five developers.",
        },
        {
            value: "~161%",
            label: "LOC Commit Ratio",
            description: "The most effective AI user on the team. Averages 22 PRs for every 100M tokens used.",
        },
        {
            value: "10+",
