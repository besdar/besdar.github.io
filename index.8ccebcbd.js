...
})({"3GEAn":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "a3b394c68ccebcbd";
"use strict";
...
document.querySelectorAll(".tech-stack-item").forEach((tooltipContainerElement)=>{
    tooltipContainerElement.addEventListener("focus", ({ currentTarget })=>{
        if (window.innerWidth < 700) return;
        const windowPadding = 10;
        const tooltipElement = currentTarget?.querySelector(".tooltip");
        if (!tooltipElement) return;
        const tooltipCoordinates = tooltipElement.getBoundingClientRect();
        if (tooltipCoordinates.x < windowPadding) tooltipElement.style.left = `${tooltipElement.offsetLeft + windowPadding - tooltipCoordinates.x}px`;
        else if (tooltipCoordinates.x + tooltipCoordinates.width > window.innerWidth - windowPadding) tooltipElement.style.left = `${window.innerWidth + tooltipElement.offsetLeft - 2 * windowPadding - tooltipCoordinates.x - tooltipCoordinates.width}px`;
    });
});

},{}]},["3GEAn","1xC6H","jyKRr"], "jyKRr", "parcelRequire3ff2")

//# sourceMappingURL=index.8ccebcbd.js.map
